import { getKeyByValue, newAbortSignal, readWallets, sleep, timestampToDate, random, getProxy, sortObjectByKey } from './common.js'
...
function fetchWallets() {
    wallets = readWallets('./wallets.txt')
...
await pohFetchDataAndPrintTable()